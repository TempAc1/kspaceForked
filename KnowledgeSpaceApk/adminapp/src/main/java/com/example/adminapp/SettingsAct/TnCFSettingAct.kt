...
// Inflate the layout for this fragment
        val view = LayoutInflater.from(context)
            .inflate(R.layout.fragment_tn_c_f_setting_act, container, false)
        tnc = view.findViewById(R.id.tncTvSettingActAdminApp)
        tnc?.setText(
        ...
        /**Your Code here  */
        tnc?.setMovementMethod(ScrollingMovementMethod())
        return view
    }
}