...
public class adapterExpListFeeAct extends BaseExpandableListAdapter {
    private Context context;
    private List<String> expandableTitleList;
    private HashMap<String, List<String>> expandableDetailList;

    // constructor
    public adapterExpListFeeAct(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int lstPosn, final int expanded_ListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.fee_act_exp_list_item, null);
        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.fee_act_exp_list_grp, null);
        }
        TextView listTitleTextView = (TextView) convertView.findViewById(R.id.listTitleFeeAct);
